...
Warunki wstępne (musi być jeden obraz: openjdk):
#docker images
...
cd C:\Users\Jacek\Documents\JAVA\SpringBoot\dockerProjects\springboot-client-docker>
#docker build -t client .
#docker run -p 12121:12121 --name client client
...
http://localhost:12121/showForGui            --  UWAGA to będzie chodziło, jeżeli uruchomimy api
...
3. --- odpalenie zbiorczego pliku docker-compos.yml       (uruchamia api, client i mysql)
